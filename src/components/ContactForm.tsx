...
const ContactForm: React.FC = () => {
    ...
    const validate = (): Partial<typeof formData> => {
        ...
        if (!formData.agree) newErrors.agree = 'You must agree to be contacted.' as any; // Type assertion for boolean
            ...
            <div className="max-w-2xl mx-auto bg-white p-8 md:p-10 border border-[#2A4B40] rounded-lg shadow-sm">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6 font-serif">
                    <FormInput
                        ...
                        placeholder="Name" error={errors.name} required
                    />
                    <FormInput
                    ...
                    />
                    <FormInput
                        label="Phone" id="phone" name="phone" type="number"
                        value={formData.phone} onChange={handleChange}
                        placeholder="(555) 234-5678" error={errors.phone} required
                    />
                     <FormTextArea
                        label="What brings you here?" id="message" name="message"
                        value={formData.message} onChange={handleChange}
                        placeholder="How can I help you?" error={errors.message} required
                    />
                    <div>
                        <FormInput
                            label="Preferred time to reach you" id="preferredTime" name="preferredTime" type="text"
                            value={formData.preferredTime} onChange={handleChange}
                            placeholder="e.g., Mornings, Afternoons, Evenings" error={errors.preferredTime} required
                        />
                    ...
                    <div className="bg-gray-100 border border-gray-300 rounded p-3 flex justify-between items-center">
                        <div className="flex items-center">
                            <div className="w-6 h-6 border-2 border-gray-400 rounded-sm flex-shrink-0"></div>
